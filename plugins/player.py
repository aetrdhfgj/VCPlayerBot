...
async def notforu(_, m: Message):
    k = await _.send_cached_media(chat_id=m.chat.id, file_id="CAACAgQAAxkBAAM_YaSW2QTcTfbt4qEQKjXo5pu0T9EAAo0JAAIsgihRhtq9HKRKQVUiBA", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('👨🏻‍🔧بیا اینجا', url='https://t.me/Maryam_Afiyat')]]))
    await delete_messages([m, k])
...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('⚡️پشتیبان ربات', url='https://t.me/Maryam_Afiyat'),
                InlineKeyboardButton('🧩  عضو شوید', url='https://t.me/Channel_Ultra'),
            ]
            ]
        await m.reply("<b>💬 من یه ربات پخش کننده آهنگ و فیلم در گروه های تلگرامی هستم ، امکانات جذابی دارم و پرسرعت  هستم با من میتونی به راحتی توی  گروهت نا محدود موزیک پخش کنی ویدیو پخش کنی .حجم فایل هم مهم نیست تا 1.5 گیگ میتونی بهم فایل موزیک یا  فیلم بدی تا توی گروهت  به صورت زنده پخش کنم. ! [پشتیبان ربات](https://t.me/Maryam_Afiyat) .</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
