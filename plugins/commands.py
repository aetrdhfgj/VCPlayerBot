...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ کانال پشتیبان 24', url='https://t.me/Channel_Ultra'),
            InlineKeyboardButton('🧩 درخواست نصب ربات', url='https://t.me/Maryam_Afiyat')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 پشتیبان ربات', url='https://t.me/Maryam_Afiyat'),
            InlineKeyboardButton('⚙️ کانال ربات', url='https://t.me/Channel_Ultra'),     
        ],
        [
            InlineKeyboardButton("🎞 نحوه فعالسازی ربات", url='https://t.me/Maryam_Afiyat'),
            InlineKeyboardButton('🗑 خروج', callback_data='close'),
        ]
    ]
    await message.reply("<b>برای اطلاع  بیشتر و نصب ربات پخش کننده موزیک و ویدیو در گروهتان با آیدی پشتیبان ربات در ارتباط باشید. <a href=https://t.me/Maryam_Afiyat>Channel_Ultra.</a>\n هم ویدیو هم موزیک قابل پخش است.\n\nبدون محدویت حجم فایل 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
        ...
        if " " in message.text:
            ...
            if "=" in env:
                ...
                if env_ in ENV_VARS:
                    ...
                    await m.edit("ورودی ارسالی نامعتبر است. از پشتیبان ربات (@Maryam_Afiyat) درخواست کمک نمایید.")
